        ...
        <section class="py-10">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mb-12  text-center flex justify-center flex-col items-center">
                    <h2 className="max-w-4xl  text-3xl/snug sm:text-4xl/snug lg:text-4xl/snug text-center font-bold text-gray-900 py-5 font-Poppins tracking-wider" data-aos="fade-up">
                        With Prontoo Acess  all the featured at <span className="text-logocolor">Wallet-friendly cost</span>
                    </h2>
                ...
                <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center mb-20">
                            ...
                            <ul class="mb-12 space-y-6 text-left text-lg ">
                                ...
                                <li class="flex items-center space-x-4">
                                    <svg class="flex-shrink-0 w-6 h-6 text-red-600" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10 10L20 20M10 20L20 10" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
                                        <circle cx="15" cy="15" r="12.5" stroke="currentColor" stroke-width="1.6" />
                                    </svg>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between p-6">
                    ...
                    <div className="w-full lg:w-1/2" data-aos="fade-right">
                        <h3 className="text-4xl font-bold mb-2 font-Barlow tracking-wider md:text-left text-center">
                            Connect with Our Vendor
                        </h3>
