    ...
    <div className='relative'>
      ...
      <section className="pt-14 md:pt-18 bg-gray-50 overflow-hidden">
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 lg:px-8">
          <div className="w-full max-w-4xl mx-auto sm:px-12">
            <h1
              className="text-4xl sm:text-6xl capitalize  leading-[50px] sm:leading-[80px] mb-6 text-center font-lora font-medium"
              data-aos="fade-up"
            >
              Your Simple Easy-in-house  <span className="text-logocolor capitalize">Food ordering</span>
            </h1>
            ...
            >
              <input
                type="email"
                className="w-full px-6 py-3.5 text-base max-sm:text-center font-normal shadow-xs max-sm:bg-white text-gray-900 bg-transparent border-none rounded-full placeholder-gray-400 focus:outline-none leading-normal md:flex hidden italic font-lora"
                placeholder="Let's Connect"
                required
              />
              <button
                className="py-3 px-6 max-sm:w-full rounded-full font-lora bg-logocolor text-white text-sm leading-4 whitespace-nowrap transition-all hover:scale-110 duration-300 font-bold sm:absolute top-1.5 right-3"
                data-aos="fade-up" 
              >
                Get Started
              </button>
            ...
            <p
              className="text-lg font-medium leading-8 text-gray-400 text-center mb-14 max-w-xl mx-auto font-lora"
              data-aos="fade-up"
            >
              ...
              >
                <a href="#" className="block">
                  <img
                    ...
                    src={img}
                    alt="Shop Banner"
                    className={`w-full h-auto rounded-lg ${isInView ? 'scale-110' : 'scale-100'} duration-1000`}
                    loading="lazy"
